...
import stepDefination.CrossWordTest;

public class ExtentReport extends CrossWordTest{
WebDriver driver;
...
System.setProperty("webdriver.chrome.driver", "C:\\Users\\user\\eclipse-workspace\\Crossword-Cucumber\\src\\test\\resources\\binaries\\chromedriver.exe");
driver=new ChromeDriver();

driver.get("https://www.google.com/");

Assert.assertTrue(driver.getTitle().contains("crossword"));
